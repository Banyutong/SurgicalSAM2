...
def visualize_all_frames(pred_pkl_file, pred_json_file, gt_json_file, frame_dir, output_dir, gt_type):
    global MOD
    ...
    if show_first_frame:
        ...
        for obj in prompt_objs:
            ...
            for point, label in zip(obj['points'], obj['pos_or_neg_label']):
                ...
                axes[0].scatter(point[0], point[1], c=marker_color, s=MARKER_SIZE, marker=marker, alpha=ALPHA,
                                edgecolor='white',
                                linewidth=linewidth)
...
# Example usage:
visualize_all_frames('Endoscapes2023_Pipeline/test/prompt.pkl',

...
def show_mask_keep_color(mask, ax, color_id, class_to_color_mapper, transparent=1.0):
    color = np.array(
        [
            class_to_color_mapper[color_id][0] / 255.0,
...
def visualize_frame(
    ...
    for class_id in unique_classes:
        ...
        print(f"gt {class_id}")
        show_mask_keep_color(
            mask, axes[2 + idx_offset], class_id, class_to_color_mapper, transparent=0.7
        )
    ...
    for class_id in unique_classes:
        ...
        show_mask_keep_color(
            mask, axes[3 + idx_offset], class_id, class_to_color_mapper, transparent=0.7
        )
